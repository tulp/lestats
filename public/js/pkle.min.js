...
PK.entityify_and_escape_quotes(a)+"</pre>"}};PK.check_namespace("Cookies");PK.Cookies.set_longlive_cookie=function(a,b,c){c=c||{};c.expires=365;$.cookie(a,b,c)};PK.init_history=function(){Ext.History.init();Ext.History.on("change",function(a){var b="",c=[];a&&(c=a.split(PK.navigation.tokenDelimiter),b=c[0],c.splice(0,1));PK.navigation.show_topic(b,c)})};PK.i18n=new function(){var a=this,b={},c=void 0;this.language={};this.set_current_language=function(a){c=a};this.get_current_language=function(){return c};this.add_language_pack=function(a,e){c===void 0&&this.set_current_language(a);b[a]=e;this.language[a]=a};this.extend_language_pack=function(c,a){if(b[c]==void 0)this.add_language_pack(c,a);else for(var f in a)b[c][f]=a[f]};this.raw_text=function(a){var e="";c===void 0?(CRITICAL_ERROR("Current language not set! Text: "+a),e="<"+a+">"):b[c]?e=b[c][a]:
(CRITICAL_ERROR("No language pack for "+c+". Text: "+a),e="<"+a+">");return e};this.text=function(c){assert(c!==void 0,"No parameters for PK.i18n.text()");var b=a.raw_text(c);if(b===void 0)return"*"+c+"*";if(arguments.length==1)return b;var f=arguments;f[0]=b;return PK.formatString.apply(window,f)}};var I18N=PK.i18n.text;PK.image_loading_error=function(a){console.log(this,a);GUI_ERROR(I18N("Failed to load: ${1}",this&&this.src?this.src:"(invalid image)"));this.loading_failure=!0};PK.check_is_image_loaded=function(a){if(!a||!a.complete)return!1;if(typeof a.naturalWidth!="undefined"&&a.naturalWidth==0)return!1;return!0};PK.check_is_image_loaded_or_failed=function(a){if(PK.check_is_image_loaded(a))return!0;return a&&a.loading_failure};if(!this.JSON)this.JSON={};
(function(){function a(c){return c<10?"0"+c:c}function b(c){e.lastIndex=0;return e.test(c)?'"'+c.replace(e,function(c){var a=h[c];return typeof a==="string"?a:"\\u"+("0000"+c.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+c+'"'}function c(a,d){var e,h,k,o,r=f,q,p=d[a];p&&typeof p==="object"&&typeof p.toJSON==="function"&&(p=p.toJSON(a));typeof i==="function"&&(p=i.call(d,a,p));switch(typeof p){case "string":return b(p);case "number":return isFinite(p)?String(p):"null";case "boolean":case "null":return String(p);
...
{"":a})};if(typeof JSON.parse!=="function")JSON.parse=function(c,a){function b(c,d){var e,g,f=c[d];if(f&&typeof f==="object")for(e in f)Object.hasOwnProperty.call(f,e)&&(g=b(f,e),g!==void 0?f[e]=g:delete f[e]);return a.call(c,d,f)}var e,c=String(c);d.lastIndex=0;d.test(c)&&(c=c.replace(d,function(c){return"\\u"+("0000"+c.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(c.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return e=eval("("+c+")"),typeof a==="function"?b({"":e},""):e;throw new SyntaxError("JSON.parse");}})();PK.log_system=new function(){var a=[],b=function(c){window.Ext?Ext.isReady&&Ext.Msg.alert("Failure",c):alert(c)};this.GUI_EOL="<br>";this.set_printer=function(c){b=c};this.get_printer=function(){return b};this.add=function(c){a[a.length]=c};this.list=function(){return a}};var LOG=PK.log_system.add,GUI_ERROR=function(a){if(window.Ext)Ext.isReady?Ext.Msg.alert("Failure",a):LOG("GUI ERROR: "+a);else{var b=PK.log_system.get_printer();b&&b(a)}};
PK.Error=new function(){var a=void 0;this.critical_error=function(b){var c;a&&(b=a(b));c=new Date(PK.Time.get_current_timestamp());b="["+(c.getDate()+"-"+(c.getMonth()+1)+"-"+c.getFullYear())+" "+c.toLocaleTimeString()+"]<br>"+b;if(window.printStackTrace){var d=["********** Stack Trace **********"],d=d.concat(window.printStackTrace());d.splice(1,2);d.push("**********************************");c=b+"\n"+d.join("\n");b=b+PK.log_system.GUI_EOL+d.join(PK.log_system.GUI_EOL)}else c=b+"\n(Stack trace not available)\n\n";
LOG("\nCRITICAL ERROR: "+c);(c=PK.log_system.get_printer())&&c(b)};this.set_custom_error_handler=function(b){a=b}};var CRITICAL_ERROR=PK.Error.critical_error;PK.check_namespace("Math");PK.Math.random_int=function(a,b){return Math.floor(Math.random()*(b-a+1))+a};PK.Math.clamp=function(a,b,c){if(b==c)return b;if(c<b)var d=b,b=c,c=d;return Math.min(Math.max(a,b),c)};PK.override_menu_item_to_enable_tooltips=function(){Ext.override(Ext.menu.Item,{onRender:function(a,b){if(!this.itemTpl)this.itemTpl=Ext.menu.Item.prototype.itemTpl=new Ext.XTemplate('<a id="{id}" class="{cls}" hidefocus="true" unselectable="on" href="{href}"','<tpl if="hrefTarget">',' target="{hrefTarget}"',"</tpl>",">",'<img src="{icon}" class="x-menu-item-icon {iconCls}"/>','<span class="x-menu-item-text">{text}</span>',"</a>");var c=this.getTemplateArgs();this.el=b?this.itemTpl.insertBefore(b,
...
hrefTarget:this.hrefTarget,icon:this.icon||Ext.BLANK_IMAGE_URL,iconCls:this.iconCls||"",text:this.itemText||this.text||" "}}})};PK.navigation=new function(){var a=!0,b;this.topic_makers={};this.topics={};this.tokenDelimiter="/";this.add_topic=function(c,a){this.topic_makers[c]=a};this.make_all_topics=function(){for(var c in this.topic_makers)this.topics[c]=this.topic_makers[c]();this.topic_makers={}};this.go_to_topic=function(c,a,b){var f=c?c:"";b===void 0&&(b=!1);if(a&&a.length)for(var g=0;g<a.length;g++)f+="/"+a[g];g=Ext.History.getToken();Ext.History.add(f);g==f&&b&&this.show_topic(c,a)};this.show_topic=function(c,d){LOG("navigator.show_topic(): "+
...
PK.override_object_properties=function(a,b,c){if(!b)return a;a||(a={});for(var d in b)if(b[d]===!0)c[d]!==void 0?a[d]=c[d]:CRITICAL_ERROR("No mandatory data for "+d+"!");else if(typeof b[d]=="function"){var e=b[d](c[d]);e!==void 0&&(a[d]=e)}else if(typeof b[d]=="object")if(c[d]!==void 0)a[d]=c[d];else if(b[d].default_value!==void 0)a[d]=b[d].default_value;return a};PK.count_properties=function(a){var b=0;try{for(var c in a)b++}catch(d){CRITICAL_ERROR("It is not dictionary! "+a)}return b};
PK.swap_keys_and_values=function(a){var b={},c;for(c in a)b[a[c]]=c;return b};PK.formatNumber=function(a,b){a=Number(a);isNaN(a)&&CRITICAL_ERROR("Wrong value!");var c=a.toString().split("."),d=c[0];c.length>1&&CRITICAL_ERROR("Can't format not integer number!");b===void 0&&(b=4);b=Number(b);isNaN(b)&&CRITICAL_ERROR("Wrong precision!");b<1&&CRITICAL_ERROR("Can't format with precision < 1!");if(d.length<b)return Array(b-d.length+1).join("0")+d;else if(d.length==b)return a;else CRITICAL_ERROR("Can't format big number!")};
PK.entityify_and_escape_quotes=function(a){if(typeof a=="number")return a;return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")};
PK.split_using_placeholders=function(a,b){if(a.length==0)return[];if(a.indexOf("${")==-1)return[PK.clone(a)];for(var c=[],d=!1,e=function(a){if(a!=void 0&&a!==""){if(a.substr(0,2)=="${"&&a.substr(a.length-1)=="}"){var e=a.substr(2,a.length-3),g=Number(e);if(isNaN(g)){if(b&&b.length&&!PK.is_value_in_array(b,e)){d=!0;c.length?c[c.length-1]+=a:c.push(a);return}}else g==g.toFixed(0)&&(a=g)}else if(d){c.length?c[c.length-1]+=a:c.push(a);d=!1;return}c.push(a)}},f=0,g=0,g=0;g!=-1;)f=a.indexOf("${",g),f!=
-1?(e(a.substr(g,f-g)),g=a.indexOf("}",f+2),g!=-1?(e(a.substr(f,g-f+1)),g+=1):(e(a.substr(f)),g=-1)):(e(a.substr(g)),g=-1);return c};
PK.fill_placeholders=function(a,b,c){if(a.indexOf("${")==-1)return PK.clone(a);if((!b||b.length==0)&&(!c||c.length==0))return PK.clone(a);if(b&&b.length==1&&(!c||c.length==0))return a.replace("${1}",b[0]);var d=void 0,e=void 0;if(c){var d=[],e={},f;for(f in c)d.push(f),e["${"+f+"}"]=c[f]}c=PK.split_using_placeholders(a,d);d=[];for(f=0;f<c.length;f++){var g=c[f];if(e&&e[g])g=e[g];else if(typeof g=="number"&&b){var h=g-1;if(b.length>h){g=b[h];d.push(g);continue}else CRITICAL_ERROR("Too big value placeholder number: "+
b.length+"<="+h),window.console&&console.log&&console.log("[PK.fill_placeholders] failed on data:",a,b,c),LOG("source: "+a),LOG("ivalues: "+JSON.stringify(b,null,4)),LOG("Data: "+JSON.stringify(c,null,4))}d.push(g)}return d.join("")};PK.formatString=function(){if(!(arguments.length<1)){var a=Array.prototype.slice.call(arguments),b=a.shift();return b=PK.fill_placeholders(b,a)}};PK.check_namespace("Obsolete");
PK.Obsolete.split_using_placeholders_very_old=function(a,b){for(var c=0;;){c++;var d="${"+c+"}";if(a.indexOf(d)<0)break;a=a.replace(d,"{%_SEP_%}"+d+"{%_SEP_%}")}if(b)for(c=0;c<b.length;c++)d="${"+b[c]+"}",a.indexOf(d)>=0&&(a=a.replace(d,"{%_SEP_%}"+d+"{%_SEP_%}"));for(var d=a.split("{%_SEP_%}"),e=[],c=0;c<d.length;c++)d[c].match(/\$\{\d+\}/g)?e.push(Number(d[c].replace(/[\$\{\}]/g,""))):d[c]!=""&&e.push(d[c]);return e};
PK.Obsolete.split_using_placeholders_old=function(a,b){var c=[],d="(\\$\\{[0-9]+\\})";if(b&&b.length)for(var e=0;e<b.length;e++)d+="|(\\$\\{"+b[e]+"\\})";d=a.split(RegExp(d));for(e=0;e<d.length;e++)if(d[e]!=void 0&&d[e]!==""){var f=d[e];if(f.substr(0,2)=="${"&&f.substr(f.length-1)=="}"){var g=f.substr(2,f.length-3),g=Number(g);isNaN(g)||g==g.toFixed(0)&&(f=g)}c.push(f)}return c};
PK.Obsolete.fill_placeholders_very_old=function(a,b){var c=PK.Obsolete.split_using_placeholders_very_old(a,void 0);if(!c)return a;for(var d=[],e=0;e<c.length;e++)if(typeof c[e]=="number"){var f=c[e]-1;b.length>f?d=d.concat(b[f]):(CRITICAL_ERROR("Too big value placeholder number: "+b.length+"<="+f),window.console&&console.log&&console.log("[PK.fill_placeholders] failed on data:",a,b,c),LOG("s: "+a),LOG("ivalues: "+JSON.stringify(b,null,4)),LOG("Data: "+JSON.stringify(c,null,4)))}else d.push(c[e]);
return d.join("")};
PK.Obsolete.fill_placeholders_old=function(a,b,c){var d=void 0,e=void 0;if(c){var d=[],e={},f;for(f in c)d.push(f),e["${"+f+"}"]=c[f]}c=PK.Obsolete.split_using_placeholders_old(a,d);d=[];for(f=0;f<c.length;f++){var g=c[f];if(e&&e[g])g=e[g];else if(typeof g=="number"&&b){var h=g-1;if(b.length>h){g=b[h];d.push(g);continue}else CRITICAL_ERROR("Too big value placeholder number: "+b.length+"<="+h),window.console&&console.log&&console.log("[PK.fill_placeholders] failed on data:",a,b,c),LOG("source: "+a),
LOG("ivalues: "+JSON.stringify(b,null,4)),LOG("Data: "+JSON.stringify(c,null,4))}d.push(g)}return d.join("")};PK.check_namespace("Time");PK.Time.get_current_timestamp=function(){return new Date*1-1};PK.Timer=new function(){this.make=function(){return new function(){var a,b;this.start=function(c){b=c;a=PK.Time.get_current_timestamp()};this.reset=function(){b=a=void 0};this.is_complete=function(){if(!a)return!0;if(PK.Time.get_current_timestamp()<a+b)return!1;this.reset();return!0}}}};Array.prototype.transpose=function(){var a=[];if(!(this instanceof Array))return a;if(this.length==0)return a;if(!(this[0]instanceof Array))return a;if(this[0].length==0)return a;for(var b=0;b<this[0].length;b++){for(var c=[],d=0;d<this.length;d++)c[d]=this[d][b];a[b]=c}return a};if(typeof jQuery!=="undefined")jQuery.transpose=function(a){if(a instanceof Array)return a.transpose()};PK.make_undo_redo=function(a){assert(a>0,"Max depth for undo/redo must be a positive value");return new function(){var b=!1,c=[],d=[],e=void 0;this.Is_read_only=function(){return b};this.Make_read_only=function(c){b=c};this.Clear=function(){this.Is_read_only()||(c=[],d=[],e=void 0)};this.Can_undo=function(){return c.length>0};this.Can_redo=function(){return d.length>0};this.Before_do=function(b){this.Is_read_only()||(c.length+1>a&&c.shift(),c.push(PK.clone(b)),d=[],e=void 0)};this.Undo=function(a){if(!this.Is_read_only()&&
this.Can_undo())return d.push(PK.clone(a)),e=c.pop(),PK.clone(e)};this.Redo=function(){if(!this.Is_read_only()&&this.Can_redo())return assert(e!==void 0,"Undefined current memento"),c.push(e),e=d.pop(),PK.clone(e)}}};PK.Query=new function(){var a;this.init=function(b){a=$.parseQuery();PK.count_properties(a)==1&&a[""]=="undefined"&&(a={});b&&b(a);return a};this.get=function(b){if(a)return a[b]};this.get_bool=function(b){if(!a)return!1;return a[b]=="1"||a[b]=="yes"||a[b]=="YES"||a[b]=="on"||a[b]=="ON"||a[b]=="true"||a[b]=="TRUE"}};PK.WebStorage=new function(){var a=!1;this.available=function(){return a};this.init=function(){if(window.localStorage===void 0)return LOG(I18N("ERROR: no localStorage() support!")),!1;return a=!0};this.read_item=function(a){if(this.available()&&a)return localStorage.getItem(a)};this.set_item=function(a,c){if(this.available()&&a){try{localStorage.setItem(a,c)}catch(d){if(d==QUOTA_EXCEEDED_ERR)return LOG(I18N("WebStorage ERROR: QUOTA_EXCEEDED_ERR")),!1}return!0}};this.remove_item=function(a){if(this.available()&&
a)return localStorage.removeItem(a)}};if(PKLE===void 0){var PKLE=new function(){this.check_namespace=function(a){this[a]===void 0&&(this[a]={});return this[a]};this.INFINITE_PERIOD_MS=864E5};PK.check_namespace("LEWidgetsImpl");PK.LEWidgetsImpl=new function(){this.html=new function(){};this.extjs=new function(){}};PK.data_tree_node_processor_makers={};PK.data_tree_operations={};PK.data_tree_visitor_makers={}};if(PKLE===void 0)PKLE=new function(){this.check_namespace=function(a){this[a]===void 0&&(this[a]={});return this[a]};this.INFINITE_PERIOD_MS=864E5},PK.check_namespace("LEWidgetsImpl"),PK.LEWidgetsImpl=new function(){this.html=new function(){};this.extjs=new function(){}},PK.data_tree_node_processor_makers={},PK.data_tree_operations={},PK.data_tree_visitor_makers={};PK.data_node_helper=new function(){this.make_node=function(){return Object({id:PK.data_node_id.give_next_node_id()})};this.tooltip_keys=["t","/t"];this.make_tooltip_block=function(a){if(!a)return{tags:{"${t}":"","${/t}":""}};var b=PK.browser_dom.generated_id();return{id:b,text:a,tags:{"${t}":'<span id="'+b+'">',"${/t}":"</span>"}}};this.wrap_problematic_node=function(a,b){return PK.LEWidgets.make_container("problematic_node",[PK.LEWidgets.make_button("","icon-warning",b),a],void 0,"problematic-node",
!1,void 0)};this.clone_scopes=function(a,b){b===void 0&&(b=!0);if(!a||a.length==0||a.length==1&&a[0]==this.DEFAULT_SCOPE){if(b)return[]}else return PK.clone(a)};this.widget_container_type=Object({LIST:"list",LIST_ITEM:"list-item",LITERAL:"literal",RECORD:"record",OPTIONAL_RECORD_ELEMENT:"optional_record_element",VALUE:"value",VARIANT:"variant"});this.VALUE_DATA_TYPE=Object({STRING:"string",NUMBER:"number",LARGE_TEXT:"large_text",DATE:"date",URL:"url",IP:"ip"});this.DEFAULT_SCOPE="";this.DEFAULT_RENDER_TEMPLATE=
"${MENU}${1}";this.DEFAULT_SIMPLE_VALUE_RENDER_TEMPLATE="${1}${MENU}";this.fill_placeholders=function(a,b,c){for(var d=[],e=0;e<a.length;e++)if(typeof a[e]=="number"){var f=a[e]-1;b&&b.length>f?d=d.concat(b[f]):(CRITICAL_ERROR("Too big value placeholder number: "+b.length+"<="+f),LOG(Ext.encode(a)))}else c&&c[a[e]]!==void 0?d.push(PK.LEWidgets.make_label(c[a[e]])):d.push(PK.LEWidgets.make_label(a[e]));return d};this.extract_top_level_delegates=function(a){if(a&&a.length!=0){for(var b=[],c=0;c<a.length;c++)a[c].delegate_to_top_level&&
(b.push(a[c]),a[c]=void 0);PK.remove_holes_in_array(a);if(b.length!=0)return b}};this.get_scoped_value=function(a,b,c){assert(b,"Scopes not defined");assert(typeof b=="object","Scopes must be an array, not '"+typeof b+"'");if(a){if(typeof a=="string"||typeof a=="number"||typeof a=="function")return a;assert(typeof a=="object","Scoped values must be an object or a string/number/function, not '"+typeof a+"'");var d=void 0;c&&b.unshift(this.DEFAULT_SCOPE);for(var e=b.length-1;e>=0;e--){var f=b[e];if(a[f]){d=
...
b},j=function(a,c,b,d,g){return function(f){f||(f=g);assert(f,"anchor id must be provided");var h=function(a){a||(a=PK.data_node_helper.make_node(),PK.data_tree_processor.create(a,e,c));PK.data_tree_controller.add_node(b,a,d)},i={};PK.data_tree_processor.get_creation_menu(i,e,c,h,!1);i.delegated?(assert(i.delegated.submenu_maker,"get_creation_menu must delegate submenu_maker!"),h=i.delegated.submenu_maker(a),PK.LEWidgets.show_choice_editor(h.menu,f)):h()}},l=function(a,c,b,d){if(!PKLE.Settings.must_render_controls()||
!PKLE.Settings.render_new_item_placeholders_in_list())return!1;a=PK.data_tree_rendering.make_handler(j(i(a,g.text_insert_item),a,c,b));return PK.LEWidgets.make_container(void 0,void 0,void 0,"list-item-placeholder",!0,d,a)},m=new function(){var a=function(a,c,b,d){PKLE.Settings.must_render_controls()&&b.push(PK.LEWidgets.make_button(void 0,"button-delete",i(d,g.text_delete_item),PK.data_tree_rendering.make_handler(function(){PK.data_tree_controller.delete_node(c)}),{check_parent:!0}))},c=function(a,
c,b,d,e){PKLE.Settings.must_render_controls()&&b.push(PK.LEWidgets.make_button(void 0,g.icon_up,i(d,g.text_move_child_up),PK.data_tree_rendering.make_handler(function(){PK.data_tree_controller.reorder_child_nodes(a,c,!0)}),{check_parent:!0},e))},b=function(a,c,b,d,e){PKLE.Settings.must_render_controls()&&b.push(PK.LEWidgets.make_button(void 0,g.icon_down,i(d,g.text_move_child_down),PK.data_tree_rendering.make_handler(function(){PK.data_tree_controller.reorder_child_nodes(a,c,!1)}),{check_parent:!0},
e))},e=function(a,c,b,d){PKLE.Settings.must_render_controls()&&(b.push(PK.LEWidgets.make_button(void 0,"button-copy",i(d,g.text_copy_item),PK.data_tree_rendering.make_handler(function(){Ext.Msg.alert("TODO","Implement 'copy' of list item.")}),{check_parent:!0},void 0,!0)),b.push(PK.LEWidgets.make_button(void 0,"button-paste",i(d,g.text_paste_item),PK.data_tree_rendering.make_handler(function(){Ext.Msg.alert("TODO","Implement 'paste' of list item.")}),{check_parent:!0},void 0,!0)))};this.render=function(f,
h,i,j,k,n,l,m,o,r,q,A,B){var j=[],E,F;B&&k!=n&&r!=2&&(k?F=B:n&&(E=B));PKLE.Settings.copy_paste_in_context_menu()&&e(h,i,j,f);r>d&&a(h,i,j,f);k||c(h,i,j,f,E);A&&(j=j.concat(l));n||b(h,i,j,f,F);A||(j=j.concat(l));j=PK.LEWidgets.make_container(void 0,j,PK.data_node_helper.widget_container_type.LIST_ITEM);return!k&&g.glue?(assert(q),PK.node_list_helper.render_with_ph(g.glue,q).concat(j)):j}},n=new function(){var a=function(a,c,b,d,f,h,k,n){var l=[],m;if(PKLE.Settings.advanced_menu_colorization()){var p=
{};PK.data_tree_processor.get_menu_class(p,e,a);if(p.menu_class)m=p.menu_class}p=PK.browser_dom.generated_id();if(f)for(var o=0;o<f.length;o++)l.push({iconCls:"button-open-change-list-item-menu",text:f[o].menu_item_text,submenu_maker:f[o].submenu_maker});l.push("-");h&&l.push({iconCls:"button-delete",text:i(a,g.text_delete_item),value:function(){PK.data_tree_controller.delete_node(b)}});l.push({iconCls:"button-left",text:i(a,g.text_insert_item_before),value:j(i(a,g.text_insert_item_before),a,c,d,
p)});l.push({iconCls:"button-right",text:i(a,g.text_insert_item_after),value:j(i(a,g.text_insert_item_after),a,c,d+1,p)});k&&l.push({iconCls:g.icon_up,text:i(a,g.text_move_child_up),value:function(){PK.data_tree_controller.reorder_child_nodes(c,b,!0)}});n&&l.push({iconCls:g.icon_down,text:i(a,g.text_move_child_down),value:function(){PK.data_tree_controller.reorder_child_nodes(c,b,!1)}});PKLE.Settings.copy_paste_in_context_menu()&&(l.push({iconCls:"button-copy",text:i(a,g.text_copy_item),disabled:!0,
value:function(){Ext.Msg.alert("TODO","Implement 'copy' of list item.")}}),l.push({iconCls:"button-paste",text:i(a,g.text_paste_item),disabled:!0,value:function(){Ext.Msg.alert("TODO","Implement 'paste' of list item.")}}));if(l.length!=0)return d=PK.data_tree_rendering.make_handler(PK.LEWidgets.make_choice_editor(!1,!1,m,l,!1,function(a){a()},!1)),f=PKLE.Settings.universal_C_button()?"&nbsp;":"C",PK.LEWidgets.make_button(f,void 0,i(a,g.text_change_item),d,{check_parent:!0},void 0,void 0,p)};this.render=
function(c,b,e,f,h,i,j,k,n,l,m){var o;PKLE.Settings.must_render_controls()&&(o=a(c,b,e,f,k,l>d,!h,!i));c=void 0;c=o?n&&g.simple_value_render_template?PK.data_node_helper.fill_placeholders(g.simple_value_render_template,[j],{"${MENU}":o}):o.concat(j):j;c=PK.LEWidgets.make_container(void 0,c,PK.data_node_helper.widget_container_type.LIST_ITEM);return!h&&g.glue?(assert(m),PK.node_list_helper.render_with_ph(g.glue,m).concat(c)):c}},k;k=f?function(){return new function(){this.reset=function(){};this.get=
...
{child_scope_provider:q}};this.up=function(){}},validate:new function(){this.down=function(a){if(a&&a.children)for(var c=0;c<a.children.length;c++)if(a.children[c]===null||a.children[c]===void 0)return{invalid:!0,description:g.title+"["+(c+1)+"]: "+I18N("List child has invalid type")+": "+typeof a.children[c]}};this.up=function(){}},render:new function(){this.down=function(){r&&r.reset();return{accept_delegated_menu_items:!0,child_scope_provider:r}};this.up=function(a,b,d,e,f,h){b=PK.data_node_helper.clone_scopes(a);
if(o){o.reset();var k=o.get();b.push(k)}var k=PKLE.Settings.use_menu_item_delegating()?n:m,r=PK.data_node_id.make_node_id(h),q=[],u=[];if(PKLE.Settings.must_render_controls()){var v=i(b,g.text_add_item);u.push(PK.LEWidgets.make_button(void 0,"button-add",v,PK.data_tree_rendering.make_handler(j(v,b,r)),{check_parent:!0}))}if(d.length==0)q=g.empty?q.concat(PK.node_list_helper.render_with_ph(g.empty,PK.node_list_helper.get_key_values(h.type,void 0,!1,!1,u))):q.concat(u);else{if(g.before){v=void 0;if(g.tooltip_block)v=
g.tooltip_block.tags,PK.data_tree_rendering.add_tooltip(g.tooltip_block.id,g.tooltip_block.text,{dismissDelay:PKLE.INFINITE_PERIOD_MS});var z=PK.node_list_helper.get_key_values(h.type,h.children[0],l(b,r,0,i(b,g.text_insert_item)));if(v)for(var t in v)z[t]=v[t];q=q.concat(PK.node_list_helper.render_with_ph(g.before,z))}for(t=0;t<d.length;t++)var v=d[t],z=e[t],G=f&&f.length>0&&f[t],H=PK.data_node_id.make_node_id(h.children[t]),A=PK.node_list_helper.get_key_values(h.type,h.children[t],l(b,r,t,i(b,g.text_insert_item))),
q=q.concat(k.render(b,r,H,t,t==0,t==d.length-1,v,z,G,d.length,A,!g.line_by_line_layout,g.line_by_line_layout?' style = "margin-right: 13px;"':!1));q=g.after?q.concat(PK.node_list_helper.render_with_ph(g.after,PK.node_list_helper.get_key_values(h.type,h.children[d.length-1],!1,l(b,r,!1,i(b,g.text_insert_item)),u))):q.concat(u)}PKLE.Settings.use_own_tags()||(q=q.concat(u));return{rendered:PK.LEWidgets.make_container(r,q,PK.data_node_helper.widget_container_type.LIST,PKLE.Settings.use_own_tags()?PK.data_node_helper.generate_css_class_name(c,
...
void 0)return c.title;return I18N("literal")},render:new function(){this.up=function(){var a=void 0;c.tooltip_block?(PK.data_tree_rendering.add_tooltip(c.tooltip_block.id,c.tooltip_block.text,{dismissDelay:PKLE.INFINITE_PERIOD_MS}),a=PK.data_node_helper.fill_placeholders(c.common,void 0,c.tooltip_block.tags)):a=c.common;return{rendered:PK.LEWidgets.make_label(a),contains_value_only:!0}}}})};PK.data_tree_node_processor_makers.record=function(a,b){var c=a.name,d="node-"+a.name,e=a.child_types,f=e.length,g=void 0,h=function(){return new function(){var a,c;this.reset=function(b){a=0;if(b&&b.children&&b.children.length>f){c=[];for(var d=f;d<b.children.length;d++)if(b.children[d]!=void 0&&b.children[d]!=null){var e=g.optional_params[d-f];typeof e=="object"&&e.in_scope?c.push(e.in_scope):c.push(void 0)}}};this.get=function(){if(a>=f){if(c&&c.length>0)return c.shift()}else{var b=e[a];a++;if(typeof b==
"object")return b.in_scope}}}},i=h(),j=h(),l=h(),m=h();return Object({create:function(a,c,b){i&&i.reset(void 0);if(f>0){a.children=[];for(var d=0;d<f;d++){var g=void 0;i&&(g=i.get());var h;if(b&&b[d])h=b[d];else{h=e[d];var j;typeof h=="string"?j=h:(assert(typeof h=="object","node_props must be a string or an object"),j=h.type);h=PK.data_node_helper.make_node();g&&c.push(g);PK.data_tree_processor.create(h,j,c);g&&c.pop()}a.children.push(h)}}},init_node:function(){if(!g){g=PK.override_object_properties(void 0,
...
render_template:PK.split_using_placeholders(b.optional[c].render_template)})}b=a=void 0}},get_name:function(){g||this.init_node();if(g.title!==void 0)return g.title;assert("No title for "+d);return I18N("record")},get_creation_menu:function(a,b){if(g.delegate_creation_menu&&(a&&(a=PK.data_node_helper.clone_scopes(a)),m&&m.reset(void 0),f!=0))for(var d=function(d){return function(e){assert(e,"child_node required by this_node_maker()");var g=[];g[d]=e;e=PK.data_node_helper.make_node();PK.data_tree_processor.create(e,
c,a,g);b(e)}},h=0;h<f;h++){var i=void 0;m&&(i=m.get());var j=e[h];if(typeof j!="string")assert(typeof j=="object","node_props must be a string or an object"),j=j.type;var l={};i&&a.push(i);PK.data_tree_processor.get_creation_menu(l,j,a,d(h));i&&a.pop();if(l.delegated)return d=l.delegated,d.submenu_caption=g.delegated_mandatory_child_names[h+1],d}},for_each:new function(){this.down=function(a){if(l)return l.reset(a),{child_scope_provider:l}};this.up=function(){}},render:new function(){this.down=function(a){var c=
!1;g.delegated_mandatory_child_names&&(c=new function(){var a;this.reset=function(){a=0};this.check=function(){a++;if(a>f)return!1;return g.delegated_mandatory_child_names[a]!==void 0}});j&&j.reset(a);return{accept_delegated_menu_items:c,child_scope_provider:j}};var a=function(a,c,b){if(PKLE.Settings.must_render_controls()&&b.length!=0){var d=PK.data_node_helper.clone_scopes(a),a=PK.data_tree_rendering.make_handler(PK.LEWidgets.make_choice_editor(!1,!1,void 0,b,!1,function(a){g.optional_params[a].in_scope&&
d.push(g.optional_params[a].in_scope);var b=PK.data_node_helper.make_node();PK.data_tree_processor.create(b,g.optional_params[a].type,d);PK.data_tree_controller.replace_node_with_index(c,f+a,b)}));return PK.LEWidgets.make_button(void 0,"button-expand",I18N(g.text_expand_optional),a,{check_parent:!0})}},c=function(a,c,b,d,e){var h=[],i=!1;if((!a||!PKLE.Settings.use_menu_item_delegating())&&PKLE.Settings.must_render_controls())h.push(PK.LEWidgets.make_button(void 0,"button-delete",I18N(g.text_delete_optional),
PK.data_tree_rendering.make_handler(function(){PK.data_tree_controller.replace_node_with_index(c,f+b,void 0)}),!0)),i=!0;h=h.concat(PK.data_node_helper.fill_placeholders(d,[e]));return i?PK.LEWidgets.make_container(void 0,h,PK.data_node_helper.widget_container_type.OPTIONAL_RECORD_ELEMENT):h};this.up=function(b,e,h,i,j,l){var m=PK.data_node_id.make_node_id(l),s=h.splice(0,f),j=[],x=void 0;if(g.tooltip_block)x=g.tooltip_block.tags,PK.data_tree_rendering.add_tooltip(g.tooltip_block.id,g.tooltip_block.text,
{dismissDelay:PKLE.INFINITE_PERIOD_MS});for(var j=j.concat(PK.data_node_helper.fill_placeholders(g.common,s,x)),x=[],D=0,y=[],s=0;s<g.optional_params.length;s++){var C=!1;l.children&&l.children[f+s]!==void 0&&l.children[f+s]!==null?(C=!0,j=j.concat(c(e,m,s,g.optional_params[s].render_template,h[D])),D++):x.push({value:s,text:g.optional_params[s].menu_item,description:g.optional_params[s].description});y.push({value:s,text:g.optional_params[s].menu_item,description:g.optional_params[s].description,
...
h.push({menu_item_text:I18N("Set/clear optional parameters"),delegate_to_top_level:!0,submenu_maker:function(a,c){return PK.LEWidgets.make_menu(c,!1,a,void 0,y,!1,function(a){g.optional_params[a].in_scope&&v.push(g.optional_params[a].in_scope);if(y[a].checkbox.state)PK.data_tree_controller.replace_node_with_index(m,f+a,void 0);else{var c=PK.data_node_helper.make_node();PK.data_tree_processor.create(c,g.optional_params[a].type,v);PK.data_tree_controller.replace_node_with_index(m,f+a,c)}})}})}}else(i=
a(b,m,x))&&j.push(i);return{rendered:PK.LEWidgets.make_container(m,j,PK.data_node_helper.widget_container_type.RECORD,PKLE.Settings.use_own_tags()?PK.data_node_helper.generate_css_class_name(d,g["class"],b):void 0),delegated_menu_items:h,contains_value_only:g.contains_value_only}}}})};PK.data_tree_node_processor_makers.value=function(a,b){var c=a.name,d="node-"+a.name,e=a.data_type,f=e==PK.data_node_helper.VALUE_DATA_TYPE.LARGE_TEXT?void 0:80,g=void 0;return Object({create:function(a,b){var d;b.unshift(PK.data_node_helper.DEFAULT_SCOPE);for(var e=b.length-1;e>=0;e--)if(d=PKLE.default_value_generators.get(c,b[e]))break;b.shift();a.children=d?[d()]:[g.default_value]},init_node:function(){g||(g=PK.override_object_properties({default_value:a["default"]},{title:{default_value:I18N("value")},
"class":{default_value:void 0},common:function(a){a||(a="${1}");return PK.split_using_placeholders(a)}},b),b=a=void 0)},get_name:function(){g||this.init_node();if(g.title!==void 0)return g.title;assert("No title for "+d);return I18N("value")},validate:new function(){this.down=function(a,b){var d=PK.data_validation.get_validator(e,c,b);if(d){var f=a&&a.children&&a.children.length>0?a.children[0]:void 0;if(!d(f))return{invalid:!0,description:g.title+": "+I18N("Value is invalid")+": "+f}}};this.up=function(){}},
render:new function(){this.up=function(a,b,j,l,m,n){var k=PK.data_node_id.make_node_id(n),b=n.children[0];PKLE.Settings.must_render_controls()?(j=void 0,PKLE.Settings.use_own_tags()&&(j=PKLE.data_value_class.get(e,c,a,b)),b=PK.LEWidgets.make_text_field(b,f,e,!0,j,PK.data_tree_rendering.make_handler(PK.LEWidgets.make_value_editor(b,function(a){PK.data_tree_controller.replace_node_with_index(k,0,a)},PK.data_validation.get_validator(e,c,a),e)))):b=PK.LEWidgets.make_label(PK.entityify_and_escape_quotes(b));
j=void 0;PKLE.Settings.use_own_tags()&&(j=PK.data_node_helper.generate_css_class_name(d,g["class"],a));return{rendered:PK.LEWidgets.make_container(k,PK.data_node_helper.fill_placeholders(g.common,b),PK.data_node_helper.widget_container_type.VALUE,j),contains_value_only:!0}}}})};PKLE.node_variant_helper=new function(){this.make_menu=function(a){for(var b=[],c=0;c<a.length;c++){var d=a[c];d.submenu?b.push({text:d.menu_item,description:d.description,submenu:PKLE.node_variant_helper.make_menu(d.submenu),submenu_caption:d.submenu_caption}):(assert(d.type,"menu item must be a submenu or must have value!"),b.push({render_template:d.render_template,value:d.type,text:d.menu_item,description:d.description}))}return b};this.get_item_by_type=function(a,b){if(a)if(b)for(var c=0;c<a.length;c++){var d=
...
a,!0)};var a={};this.make_text=function(c,b){var d=c.join()+":"+b,e=a[d];if(e)return e;e=PK.data_node_helper.get_scoped_value(g.element_name,c,!0);e=PK.fill_placeholders(b,[e]);return a[d]=e};this.get_default_variant=function(a){a=PK.data_node_helper.get_scoped_value(e,a,!0);assert(a!==void 0,"Undefined default variant");return a};this.get_menu_render_template=function(a){for(var c in g.menu_by_scope)for(var b=0;b<g.menu_by_scope[c].length;b++)if(g.menu_by_scope[c][b].value==a)return g.menu_by_scope[c][b].render_template;
return PK.data_node_helper.DEFAULT_RENDER_TEMPLATE};this.make_own_menu=function(a,c){var b=PK.clone(g.menu_by_scope[PK.data_node_helper.DEFAULT_SCOPE]);if(a&&(a.length>1||a.length==1&&a[0]!=PK.data_node_helper.DEFAULT_SCOPE))for(var d={},e=0;e<a.length;e++)if(a[e]!=PK.data_node_helper.DEFAULT_SCOPE&&!d[a[e]]&&(d[a[e]]=!0,g.menu_by_scope[a[e]]))for(var f=g.menu_by_scope[a[e]],h=0;h<f.length;h++){for(var i=!1,p=0;p<b.length;p++)if(assert(b[p].text,"Menu item has no text!"),b[p].text==f[h].text)if(b[p].submenu){assert(f[h].submenu,
"Additional menu item has no submenu: ");b[p].submenu=b[p].submenu.concat(PK.clone(f[h].submenu));i=!0;break}else CRITICAL_ERROR("Same menu item name, but no submenu: ");i||b.push(PK.clone(f[h]))}PKLE.node_variant_helper.expand_all_leaves(b,a,c);return b};this.make_menu_with_delegated_items=function(a,c,b,d){a=this.make_own_menu(a,d);if(!b||b.length==0||b[0].length==0)return a;if(c=PKLE.node_variant_helper.get_item_by_type(a,c))if(b=b[0],b.length==0)CRITICAL_ERROR("No menu items delegated by first child");
else if(b.length==1)c.submenu_maker=b[0].submenu_maker,c.submenu_caption=b[0].submenu_caption;else{for(var d=[],e=0;e<b.length;e++)d.push({submenu_maker:b[e].submenu_maker,text:b[e].menu_item_text,submenu_caption:b[e].submenu_caption});c.submenu=d}return a}};return Object({create:function(a,c,b){b||(b=PK.data_node_helper.make_node(),PK.data_tree_processor.create(b,h.get_default_variant(c),c));a.children=[b]},init_node:function(){if(!g){g=PK.override_object_properties(void 0,{title:!0,"class":{default_value:void 0},
...
b,d){if((!d||g.delegate_creation_menu)&&PKLE.Settings.use_creation_menu_delegating())return a=PK.data_node_helper.clone_scopes(a),{submenu_maker:function(d,e){var g=function(a){assert(a,"child_node required by this_node_maker()");var d=PK.data_node_helper.make_node();PK.data_tree_processor.create(d,c,void 0,a);b(d)},f=h.make_own_menu(a,g),l=h.get_menu_class(a);return PK.LEWidgets.make_menu(e,!1,d,l,f,PKLE.menu_transformers.get(c,a),function(c){var b=PK.data_node_helper.make_node();PK.data_tree_processor.create(b,
c,a);g(b)})}}},get_name:function(a){g||this.init_node();a||(a=[]);return PK.data_node_helper.get_scoped_value(g.element_name,a,!0)},get_menu_class:function(a){g||this.init_node();return h.get_menu_class(a)},render:new function(){var a=function(a,c,b,d){if(!PKLE.Settings.must_render_controls())return"";var e;d&&d.length>0&&(e=PK.data_node_helper.extract_top_level_delegates(d[0]));c=PK.data_tree_rendering.make_handler(PKLE.node_variant_helper.make_choice_editor_maker(h,c,a,d,e,b));b=PKLE.Settings.universal_C_button()?
"&nbsp;":g.label;return PK.LEWidgets.make_button(b,g.icon,h.make_text(a,g.text_change_item),c,!0)};this.down=function(){return{accept_delegated_menu_items:!0}};this.up=function(b,e,f,n,k,o){var k=k&&k.length>0&&k[0],r=PK.data_node_id.make_node_id(o),q=[],p=void 0;if(o.children&&o.children.length>0)p=o.children[0].type;o=void 0;if(e){var w;n&&n.length>0&&(w=PK.data_node_helper.extract_top_level_delegates(n[0]));b=PK.data_node_helper.clone_scopes(b);o=[{menu_item_text:h.make_text(b,g.text_change_item),
delegate_to_top_level:!1,submenu_maker:function(a,d){var e=h.make_menu_with_delegated_items(b,p,n,PKLE.node_variant_helper.make_root_node_maker(r)),g=p,f=h.get_menu_class(b);return PK.LEWidgets.make_menu(d,g,a,f,e,PKLE.menu_transformers.get(c,b),function(a){var c=PK.data_node_helper.make_node();PK.data_tree_processor.create(c,a,b);PK.data_tree_controller.replace_node_with_index(r,0,c)})}}];w&&(o=o.concat(w))}e=void 0;w=PK.split_using_placeholders(h.get_menu_render_template(p),["MENU"]);if(g.render_choice_control_always||
!o){e=a(b,r,p,n);if(k&&g.simple_value_render_template)w=g.simple_value_render_template;k=!1}f.length==0&&CRITICAL_ERROR("No children items for variant "+r);q=q.concat(PK.data_node_helper.fill_placeholders(w,f,{"${MENU}":e?e:""}));return{rendered:PK.LEWidgets.make_container(r,q,PK.data_node_helper.widget_container_type.VARIANT,PKLE.Settings.use_own_tags()?PK.data_node_helper.generate_css_class_name(d,g["class"],b):void 0),delegated_menu_items:o,contains_value_only:k}}}})};PK.data_tree_controller=new function(){var a,b,c;this.operation_type={ADD_NODE:1,DELETE_NODE:2,REPLACE_NODE:3,REPLACE_NODE_WITH_INDEX:4,REORDER_CHILD_NODES:5};this.init=function(d,e,f){a=d;b=e;c=f};this.add_node=function(d,e,f){assert(e.id,"No node id!");if(!b||b()){var g=PK.data_tree_processor.find(a,d);assert(g,"node not found: "+Ext.encode(d));d=g.node;d.children===void 0?d.children=[e]:f===void 0||f===!1?d.children.push(e):d.children.splice(f,0,e);c&&c(this.operation_type.ADD_NODE,d,e,f)}};this.delete_node=
...
i),!1;for(var l=l.split("."),m=h,n=0;n<l.length;n++){var k=parseInt(l[n]);if(!k)return CRITICAL_ERROR("Invalid format of error message (2):"+i),!1;k--;c?m=c(n,k,m):(assert(m.children[k],"Invalid index of problematic child"),m=m.children[k])}return{node:m,msg:b?b(h,l,j[2],j[3]):i}}};this.get_problematic_node_qualifiers_by_node_type=function(c){assert(c,"No node type");return a[c]};this.add_problematic_node_qualifier=function(c,b){assert(c,"No node type");a[c]||(a[c]=[]);a[c].push(b)};this.add_simple_problematic_node_qualifier=
function(a,c,f,g){this.add_problematic_node_qualifier(a,b(c,f,g))};this.add_natural_problematic_node_qualifier=function(a,b,f,g){this.add_problematic_node_qualifier(a,c(b,f,g))};this.determine_problematic_node=function(c,b){if(!b)return!1;var f=PK.data_tree_processor.determine_problematic_node(c,b.stack,b.line_number_table);assert(f,"problematic node not found");var g=b.msg;if(b.msg){var h;a:{h=f;var i=b.msg;if(i&&a[h.type])for(var j=a[h.type],l=0;l<j.length;l++){var m=j[l](h,i);if(m){h=m;break a}}h=
...
PK.LEWidgetsImpl.html.make_menu=function(a,b,c,d,e,f,g,h,i){PKLE.Settings.enable_menu_colorization()||(d=void 0);assert(typeof e=="object","menu_items must be an array, not a "+typeof e);assert(typeof g=="function","on_change must be a function, not a "+typeof g+", menu_items: "+Ext.encode(e));h===void 0&&(h=!0);i===void 0&&(i=!1);var j=[],l=!1,m=!1;c&&j.push({text:c,ctCls:"choice_caption",xtype:"menutextitem"});for(c=0;c<e.length;c++){var n=!1;if(e[c]===null)CRITICAL_ERROR("Menu items contains null!");
else if(typeof e[c]=="string")j.push(e[c]);else{var k=PK.clone(e[c]);f&&f.transform_item&&(k=f.transform_item(k));if(a)k.disabled=!0;if(k){k.disabled||(m=!0);if(k.submenu_maker||k.submenu){var o;o=k.submenu_maker?k.submenu_maker(k.submenu_caption,k.disabled):PK.LEWidgetsImpl.html.make_menu(a,b,k.submenu_caption,d,k.submenu,f,g,void 0,!0);k.submenu=o.menu;n=o.contains_current_choice;k.disabled=!o.contains_enabled_items;o.contains_enabled_items&&(m=!0)}else if(!k.disabled)k.handler=function(a){g(a.value)};
b!==void 0&&b!==!1&&k.value==b&&(n=!0);k.additionalCls=d;if(n){if(h)k.additionalCls="current_variant_choice";l=!0}PK.LEWidgetsImpl.html.add_menu_item_(j,k)}}}a=new Ext.menu.Menu({enableScrolling:!0,floating:!0,showSeparator:!1,items:j,cls:d});!i&&f&&f.transform_menu&&(a=f.transform_menu(a));return{menu:a,contains_current_choice:l,contains_enabled_items:m}};PK.LEWidgetsImpl.html.show_choice_editor=function(a,b){Ext.QuickTips.disable();Ext.QuickTips.enable();Ext.get(b).parent();a.render();a.show(b)};
PK.LEWidgetsImpl.html.make_choice_editor=function(a,b,c,d,e,f,g){return function(h){var i=PK.LEWidgetsImpl.html.make_menu(!1,a,b,c,d,e,f,g,!1);PK.LEWidgetsImpl.html.show_choice_editor(i.menu,h)}};PK.LEWidgetsImpl.html.make_container=function(a,b,c,d,e,f,g){a=a?"node-"+a:PK.browser_dom.generated_id();e=e?"div":"span";d||(d="container-"+c);d=d.replace(/\./gi,"-");c="<"+e+' id="'+a+'" class="'+d+'"';f&&PK.data_tree_rendering.add_tooltip(a,f);g&&(c+=' onclick="'+g+"('"+a+"')\"");c+=">";if(!b)return c+" </"+e+">";return[c,PK.LEWidgetsImpl.html.helper.wrap_object(b)," </"+e+">"]};PK.LEWidgetsImpl.html.make_label=function(a){return PK.LEWidgetsImpl.html.helper.wrap_object(a)};PK.LEWidgetsImpl.html.make_value_editor=function(a,b,c,d){return function(e){var f=Ext.get(e),g=f.dom.innerHTML,h=!1,e=d==PK.data_node_helper.VALUE_DATA_TYPE.LARGE_TEXT,i=d==PK.data_node_helper.VALUE_DATA_TYPE.DATE,j={xtype:"textfield",selectOnFocus:!0};e?j={xtype:"textarea",selectOnFocus:!0}:i&&(j={xtype:"datefield",selectOnFocus:!1,editable:!1,format:"d.m.Y"});f.getSize().width<Ext.util.TextMetrics.measure(f,"WWWWW").width&&f.update("WWWWW");var l;l=new Ext.Editor(Ext.apply({autoSize:e?!0:"width",
alignment:"l-l",hideEl:!0,listeners:{canceledit:function(){f.update(g)},beforecomplete:function(a,b){if(c&&!c(b))return Ext.Msg.alert(I18N("Error"),I18N("Value is invalid")+": "+b,function(){l.show(!0)}),!1;return!0},complete:function(a,c,d){a=c;i&&(a=c.format("d.m.Y"));a!==d&&(b(a),h=!0)},beforehide:function(){h||f.update(g)}},field:j},{shadow:!1,completeOnEnter:!0,cancelOnEsc:!0,updateEl:!0,ignoreNoChange:!0}));l.startEdit(f,a)}};
PK.LEWidgetsImpl.html.make_text_field=function(a,b,c,d,e,f){d===void 0&&(d=!0);var g=void 0,h=void 0;if(b!==void 0&&a.length>b){h=0;for(g="";g.length<800&&h<a.length;)g+=PK.entityify_and_escape_quotes(a.substring(h,h+80))+"<br>",h+=80;g.length>=800&&(g+="..");h="auto";a.length>800&&(h=450);a=a.substring(0,b)+".."}b=PK.browser_dom.generated_id();c=c==PK.data_node_helper.VALUE_DATA_TYPE.LARGE_TEXT?"editable-large-text":"editable-text";e&&(c+=" "+e);e="";f&&(e=' onclick="'+f+"('"+b+"')\"");g&&PK.data_tree_rendering.add_tooltip(b,
g,{width:h});return PK.LEWidgetsImpl.html.helper.wrap_object('<span id="'+b+'" class="'+c+'"'+e+">"+(d?PK.entityify_and_escape_quotes(a):a)+"</span>")};PK.LEWidgetsImpl.html.helper=new function(){this.wrap_object=function(a){if(a instanceof Array)return a;return[a]};var a=function(a){if(typeof a=="undefined")return"";if(typeof a=="string"||typeof a=="number")return a;assert(typeof a=="object"&&a instanceof Array,"items is not array or string/number: "+typeof a);if(a.length==0)return"";for(var b=[],a=[{items:a,i:0}];a.length>0;){var e=a[a.length-1];e.i>=e.items.length?(e.items.length=0,a.pop()):(e=e.items[e.i],a[a.length-1].i++,typeof e!="undefined"&&
...
this.highlight_parent=function(a,d){b(a,d,!0)};this.unhighlight_parent=function(a,d){b(a,d,!1)}};PK.node_schema={"tq.date":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.date",init:{"":"tq.date.now","tq.date.from":"tq.date.value"}},{label:"\u0414",title:"\u0414\u0430\u0442\u0430",scopes:{"":[{type:"tq.date.now",render_template:"${MENU}${1}",menu_item:"\u0421\u0435\u0439\u0447\u0430\u0441",description:""},{type:"tq.date.value",render_template:"${MENU}${1}",menu_item:"\u041a\u043e\u043d\u043a\u0440\u0435\u0442\u043d\u0430\u044f \u0434\u0430\u0442\u0430",description:""}]}})},
"tq.sq":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.sq"},{label:"\u0444",title:"\u0424\u0438\u043b\u044c\u0442\u0440",scopes:{"":[{type:"tq.sq.reviews",render_template:"<h3>\u041e\u0442\u0437\u044b\u0432\u044b:${MENU}</h3>${1}",menu_item:"\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043a\u0430 \u043f\u043e \u043e\u0442\u0437\u044b\u0432\u0430\u043c",description:""},{type:"tq.sq.users",render_template:"<h3>\u041f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u0438:${MENU}</h3>${1}",
menu_item:"\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043a\u0430 \u043f\u043e \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f\u043c",description:""}]}})},"tq.sq.reviews.filter.date":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.sq.reviews.filter.date"},{label:"\u0424",title:"\u0424\u0438\u043b\u044c\u0442\u0440 \u043f\u043e \u0434\u0430\u0442\u0435",scopes:{"":[{type:"tq.sq.reviews.filter.date.off",render_template:"${MENU}${1}",menu_item:"\u041d\u0435 \u0444\u0438\u043b\u044c\u0442\u0440\u043e\u0432\u0430\u0442\u044c",
description:""},{type:"tq.sq.reviews.filter.date.on",render_template:"${MENU}${1}",menu_item:"\u0424\u0438\u043b\u044c\u0442\u0440\u043e\u0432\u0430\u0442\u044c",description:""}]}})},"tq.sq.users.filter.date":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.sq.users.filter.date"},{label:"\u0424",title:"\u0424\u0438\u043b\u044c\u0442\u0440 \u043f\u043e \u0434\u0430\u0442\u0435",scopes:{"":[{type:"tq.sq.users.filter.date.off",render_template:"${MENU}${1}",menu_item:"\u041d\u0435 \u0444\u0438\u043b\u044c\u0442\u0440\u043e\u0432\u0430\u0442\u044c",
description:""},{type:"tq.sq.users.filter.date.on",render_template:"${MENU}${1}",menu_item:"\u0424\u0438\u043b\u044c\u0442\u0440\u043e\u0432\u0430\u0442\u044c",description:""}]}})},"tq.city":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.city"},{label:"\u0413",title:"\u0413\u043e\u0440\u043e\u0434",scopes:{"":[{type:"tq.city.moscow",render_template:"${MENU}${1}",menu_item:"\u041c\u043e\u0441\u043a\u0432\u0430",description:""},{type:"tq.city.saint-petersburg",render_template:"${MENU}${1}",
menu_item:"\u0421\u0430\u043d\u043a\u0442-\u041f\u0435\u0442\u0435\u0440\u0431\u0443\u0440\u0433",description:""},{type:"tq.city.samara",render_template:"${MENU}${1}",menu_item:"\u0421\u0430\u043c\u0430\u0440\u0430",description:""},{type:"tq.city.omsk",render_template:"${MENU}${1}",menu_item:"\u041e\u043c\u0441\u043a",description:""},{type:"tq.city.novosibirsk",render_template:"${MENU}${1}",menu_item:"\u041d\u043e\u0432\u043e\u0441\u0438\u0431\u0438\u0440\u0441\u043a",description:""},{type:"tq.city.ekaterinburg",
render_template:"${MENU}${1}",menu_item:"\u0415\u043a\u0430\u0442\u0435\u0440\u0438\u043d\u0431\u0443\u0440\u0433",description:""},{type:"tq.city.nizhny-novgorod",render_template:"${MENU}${1}",menu_item:"\u041d\u0438\u0436\u043d\u0438\u0439 \u041d\u043e\u0432\u0433\u043e\u0440\u043e\u0434",description:""},{type:"tq.city.rostov-na-donu",render_template:"${MENU}${1}",menu_item:"\u0420\u043e\u0441\u0442\u043e\u0432-\u043d\u0430-\u0414\u043e\u043d\u0443",description:""},{type:"tq.city.ufa",render_template:"${MENU}${1}",
menu_item:"\u0423\u0444\u0430",description:""},{type:"tq.city.kazan",render_template:"${MENU}${1}",menu_item:"\u041a\u0430\u0437\u0430\u043d\u044c",description:""},{type:"tq.city.perm",render_template:"${MENU}${1}",menu_item:"\u041f\u0435\u0440\u043c\u044c",description:""}]}})},"tq.city.moscow":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.city.moscow"},{common:"\u041c\u043e\u0441\u043a\u0432\u0430",title:"tq.city"})},"tq.city.saint-petersburg":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.city.saint-petersburg"},{common:"\u0421\u0430\u043d\u043a\u0442-\u041f\u0435\u0442\u0435\u0440\u0431\u0443\u0440\u0433",title:"tq.city"})},"tq.city.samara":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.city.samara"},{common:"\u0421\u0430\u043c\u0430\u0440\u0430",title:"tq.city"})},"tq.city.omsk":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.city.omsk"},{common:"\u041e\u043c\u0441\u043a",title:"tq.city"})},"tq.city.novosibirsk":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.city.novosibirsk"},{common:"\u041d\u043e\u0432\u043e\u0441\u0438\u0431\u0438\u0440\u0441\u043a",title:"tq.city"})},"tq.city.ekaterinburg":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.city.ekaterinburg"},{common:"\u0415\u043a\u0430\u0442\u0435\u0440\u0438\u043d\u0431\u0443\u0440\u0433",title:"tq.city"})},"tq.city.nizhny-novgorod":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.city.nizhny-novgorod"},{common:"\u041d\u0438\u0436\u043d\u0438\u0439 \u041d\u043e\u0432\u0433\u043e\u0440\u043e\u0434",
title:"tq.city"})},"tq.city.rostov-na-donu":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.city.rostov-na-donu"},{common:"\u0420\u043e\u0441\u0442\u043e\u0432-\u043d\u0430-\u0414\u043e\u043d\u0443",title:"tq.city"})},"tq.city.ufa":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.city.ufa"},{common:"\u0423\u0444\u0430",title:"tq.city"})},"tq.city.kazan":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.city.kazan"},
{common:"\u041a\u0430\u0437\u0430\u043d\u044c",title:"tq.city"})},"tq.city.perm":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.city.perm"},{common:"\u041f\u0435\u0440\u043c\u044c",title:"tq.city"})},"tq.date.now":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.now"},{common:"\u0421\u0435\u0439\u0447\u0430\u0441"})},"tq.date.value":{handler:PK.data_tree_node_processor_makers.record({child_types:["tq.date.value.day","tq.date.value.month",
"tq.date.value.year"],name:"tq.date.value"},{common:"${1} / ${2} / ${3}",title:"\u041a\u043e\u043d\u043a\u0440\u0435\u0442\u043d\u0430\u044f \u0434\u0430\u0442\u0430"})},"tq.date.value.day":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.date.value.day"},{label:"\u0434",title:"\u0414\u0435\u043d\u044c",scopes:{"":[{type:"tq.date.value.day.01",render_template:"${MENU}${1}",menu_item:"01",description:""},{type:"tq.date.value.day.02",render_template:"${MENU}${1}",menu_item:"02",
description:""},{type:"tq.date.value.day.03",render_template:"${MENU}${1}",menu_item:"03",description:""},{type:"tq.date.value.day.04",render_template:"${MENU}${1}",menu_item:"04",description:""},{type:"tq.date.value.day.05",render_template:"${MENU}${1}",menu_item:"05",description:""},{type:"tq.date.value.day.06",render_template:"${MENU}${1}",menu_item:"06",description:""},{type:"tq.date.value.day.07",render_template:"${MENU}${1}",menu_item:"07",description:""},{type:"tq.date.value.day.08",render_template:"${MENU}${1}",
menu_item:"08",description:""},{type:"tq.date.value.day.09",render_template:"${MENU}${1}",menu_item:"09",description:""},{type:"tq.date.value.day.10",render_template:"${MENU}${1}",menu_item:"10",description:""},{type:"tq.date.value.day.11",render_template:"${MENU}${1}",menu_item:"11",description:""},{type:"tq.date.value.day.12",render_template:"${MENU}${1}",menu_item:"12",description:""},{type:"tq.date.value.day.13",render_template:"${MENU}${1}",menu_item:"13",description:""},{type:"tq.date.value.day.14",
render_template:"${MENU}${1}",menu_item:"14",description:""},{type:"tq.date.value.day.15",render_template:"${MENU}${1}",menu_item:"15",description:""},{type:"tq.date.value.day.16",render_template:"${MENU}${1}",menu_item:"16",description:""},{type:"tq.date.value.day.17",render_template:"${MENU}${1}",menu_item:"17",description:""},{type:"tq.date.value.day.18",render_template:"${MENU}${1}",menu_item:"18",description:""},{type:"tq.date.value.day.19",render_template:"${MENU}${1}",menu_item:"19",description:""},
{type:"tq.date.value.day.20",render_template:"${MENU}${1}",menu_item:"20",description:""},{type:"tq.date.value.day.21",render_template:"${MENU}${1}",menu_item:"21",description:""},{type:"tq.date.value.day.22",render_template:"${MENU}${1}",menu_item:"22",description:""},{type:"tq.date.value.day.23",render_template:"${MENU}${1}",menu_item:"23",description:""},{type:"tq.date.value.day.24",render_template:"${MENU}${1}",menu_item:"24",description:""},{type:"tq.date.value.day.25",render_template:"${MENU}${1}",
menu_item:"25",description:""},{type:"tq.date.value.day.26",render_template:"${MENU}${1}",menu_item:"26",description:""},{type:"tq.date.value.day.27",render_template:"${MENU}${1}",menu_item:"27",description:""},{type:"tq.date.value.day.28",render_template:"${MENU}${1}",menu_item:"28",description:""},{type:"tq.date.value.day.29",render_template:"${MENU}${1}",menu_item:"29",description:""},{type:"tq.date.value.day.30",render_template:"${MENU}${1}",menu_item:"30",description:""},{type:"tq.date.value.day.31",
render_template:"${MENU}${1}",menu_item:"31",description:""}]}})},"tq.date.value.day.01":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.01"},{common:"01",title:"tq.date.value.day"})},"tq.date.value.day.02":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.02"},{common:"02",title:"tq.date.value.day"})},"tq.date.value.day.03":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.03"},
{common:"03",title:"tq.date.value.day"})},"tq.date.value.day.04":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.04"},{common:"04",title:"tq.date.value.day"})},"tq.date.value.day.05":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.05"},{common:"05",title:"tq.date.value.day"})},"tq.date.value.day.06":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.06"},{common:"06",title:"tq.date.value.day"})},
"tq.date.value.day.07":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.07"},{common:"07",title:"tq.date.value.day"})},"tq.date.value.day.08":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.08"},{common:"08",title:"tq.date.value.day"})},"tq.date.value.day.09":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.09"},{common:"09",title:"tq.date.value.day"})},"tq.date.value.day.10":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.date.value.day.10"},{common:"10",title:"tq.date.value.day"})},"tq.date.value.day.11":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.11"},{common:"11",title:"tq.date.value.day"})},"tq.date.value.day.12":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.12"},{common:"12",title:"tq.date.value.day"})},"tq.date.value.day.13":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.13"},
{common:"13",title:"tq.date.value.day"})},"tq.date.value.day.14":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.14"},{common:"14",title:"tq.date.value.day"})},"tq.date.value.day.15":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.15"},{common:"15",title:"tq.date.value.day"})},"tq.date.value.day.16":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.16"},{common:"16",title:"tq.date.value.day"})},
"tq.date.value.day.17":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.17"},{common:"17",title:"tq.date.value.day"})},"tq.date.value.day.18":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.18"},{common:"18",title:"tq.date.value.day"})},"tq.date.value.day.19":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.19"},{common:"19",title:"tq.date.value.day"})},"tq.date.value.day.20":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.date.value.day.20"},{common:"20",title:"tq.date.value.day"})},"tq.date.value.day.21":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.21"},{common:"21",title:"tq.date.value.day"})},"tq.date.value.day.22":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.22"},{common:"22",title:"tq.date.value.day"})},"tq.date.value.day.23":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.23"},
{common:"23",title:"tq.date.value.day"})},"tq.date.value.day.24":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.24"},{common:"24",title:"tq.date.value.day"})},"tq.date.value.day.25":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.25"},{common:"25",title:"tq.date.value.day"})},"tq.date.value.day.26":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.26"},{common:"26",title:"tq.date.value.day"})},
"tq.date.value.day.27":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.27"},{common:"27",title:"tq.date.value.day"})},"tq.date.value.day.28":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.28"},{common:"28",title:"tq.date.value.day"})},"tq.date.value.day.29":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.29"},{common:"29",title:"tq.date.value.day"})},"tq.date.value.day.30":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.date.value.day.30"},{common:"30",title:"tq.date.value.day"})},"tq.date.value.day.31":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.day.31"},{common:"31",title:"tq.date.value.day"})},"tq.date.value.month":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.date.value.month"},{label:"M",title:"\u041c\u0435\u0441\u044f\u0446",scopes:{"":[{type:"tq.date.value.month.01",render_template:"${MENU}${1}",menu_item:"\u042f\u043d\u0432\u0430\u0440\u044c",
description:""},{type:"tq.date.value.month.02",render_template:"${MENU}${1}",menu_item:"\u0424\u0435\u0432\u0440\u0430\u043b\u044c",description:""},{type:"tq.date.value.month.03",render_template:"${MENU}${1}",menu_item:"\u041c\u0430\u0440\u0442",description:""},{type:"tq.date.value.month.04",render_template:"${MENU}${1}",menu_item:"\u0410\u043f\u0440\u0435\u043b\u044c",description:""},{type:"tq.date.value.month.05",render_template:"${MENU}${1}",menu_item:"\u041c\u0430\u0439",description:""},{type:"tq.date.value.month.06",
render_template:"${MENU}${1}",menu_item:"\u0418\u044e\u043d\u044c",description:""},{type:"tq.date.value.month.07",render_template:"${MENU}${1}",menu_item:"\u0418\u044e\u043b\u044c",description:""},{type:"tq.date.value.month.08",render_template:"${MENU}${1}",menu_item:"\u0410\u0432\u0433\u0443\u0441\u0442",description:""},{type:"tq.date.value.month.09",render_template:"${MENU}${1}",menu_item:"\u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c",description:""},{type:"tq.date.value.month.10",render_template:"${MENU}${1}",
menu_item:"\u041e\u043a\u0442\u044f\u0431\u0440\u044c",description:""},{type:"tq.date.value.month.11",render_template:"${MENU}${1}",menu_item:"\u041d\u043e\u044f\u0431\u0440\u044c",description:""},{type:"tq.date.value.month.12",render_template:"${MENU}${1}",menu_item:"\u0414\u0435\u043a\u0430\u0431\u0440\u044c",description:""}]}})},"tq.date.value.month.01":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.month.01"},{common:"\u042f\u043d\u0432\u0430\u0440\u044c",
title:"tq.date.value.month"})},"tq.date.value.month.02":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.month.02"},{common:"\u0424\u0435\u0432\u0440\u0430\u043b\u044c",title:"tq.date.value.month"})},"tq.date.value.month.03":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.month.03"},{common:"\u041c\u0430\u0440\u0442",title:"tq.date.value.month"})},"tq.date.value.month.04":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
...
name:"tq.date.value.month.07"},{common:"\u0418\u044e\u043b\u044c",title:"tq.date.value.month"})},"tq.date.value.month.08":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.month.08"},{common:"\u0410\u0432\u0433\u0443\u0441\u0442",title:"tq.date.value.month"})},"tq.date.value.month.09":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.month.09"},{common:"\u0421\u0435\u043d\u0442\u044f\u0431\u0440\u044c",title:"tq.date.value.month"})},
"tq.date.value.month.10":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.month.10"},{common:"\u041e\u043a\u0442\u044f\u0431\u0440\u044c",title:"tq.date.value.month"})},"tq.date.value.month.11":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.month.11"},{common:"\u041d\u043e\u044f\u0431\u0440\u044c",title:"tq.date.value.month"})},"tq.date.value.month.12":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.date.value.month.12"},{common:"\u0414\u0435\u043a\u0430\u0431\u0440\u044c",title:"tq.date.value.month"})},"tq.date.value.year":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.date.value.year"},{label:"\u0413",title:"\u0413\u043e\u0434",scopes:{"":[{type:"tq.date.value.year.2012",render_template:"${MENU}${1}",menu_item:"2012",description:""},{type:"tq.date.value.year.2011",render_template:"${MENU}${1}",menu_item:"2011",description:""},{type:"tq.date.value.year.2010",
render_template:"${MENU}${1}",menu_item:"2010",description:""},{type:"tq.date.value.year.2009",render_template:"${MENU}${1}",menu_item:"2009",description:""},{type:"tq.date.value.year.2008",render_template:"${MENU}${1}",menu_item:"2008",description:""},{type:"tq.date.value.year.2007",render_template:"${MENU}${1}",menu_item:"2007",description:""}]}})},"tq.date.value.year.2012":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.year.2012"},{common:"2012",title:"tq.date.value.year"})},
"tq.date.value.year.2011":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.year.2011"},{common:"2011",title:"tq.date.value.year"})},"tq.date.value.year.2010":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.year.2010"},{common:"2010",title:"tq.date.value.year"})},"tq.date.value.year.2009":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.year.2009"},{common:"2009",title:"tq.date.value.year"})},
"tq.date.value.year.2008":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.year.2008"},{common:"2008",title:"tq.date.value.year"})},"tq.date.value.year.2007":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.date.value.year.2007"},{common:"2007",title:"tq.date.value.year"})},"tq.user.role":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.user.role"},{label:"\u0440",title:"\u0420\u043e\u043b\u044c \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f",
scopes:{"":[{type:"tq.user.role.any",render_template:"${MENU}${1}",menu_item:"\u041b\u044e\u0431\u0430\u044f",description:""},{type:"tq.user.role.tulper",render_template:"${MENU}${1}",menu_item:"\u0422\u044e\u043b\u044c\u043f\u0435\u0440",description:""},{type:"tq.user.role.press-manager",render_template:"${MENU}${1}",menu_item:"\u041f\u0440\u0435\u0441\u0441-\u043c\u0435\u043d\u0435\u0434\u0436\u0435\u0440",description:""}]}})},"tq.user.role.any":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.user.role.any"},{common:"\u041b\u044e\u0431\u0430\u044f",title:"tq.user.role"})},"tq.user.role.tulper":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.user.role.tulper"},{common:"\u0422\u044e\u043b\u044c\u043f\u0435\u0440",title:"tq.user.role"})},"tq.user.role.press-manager":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.user.role.press-manager"},{common:"\u041f\u0440\u0435\u0441\u0441-\u043c\u0435\u043d\u0435\u0434\u0436\u0435\u0440",
title:"tq.user.role"})},"tq.root":{handler:PK.data_tree_node_processor_makers.record({child_types:["tq.sq"],name:"tq.root"},{common:'<div style="padding:10px">${1}</div>',title:"\u041a\u043e\u0440\u0435\u043d\u044c"})},"tq.sq.reviews.filter.thanks.visible":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.sq.reviews.filter.thanks.visible"},{label:"\u0431",title:"\u041e\u0442\u043e\u0431\u0440\u0430\u0436\u0430\u0442\u044c \u0447\u0438\u0441\u043b\u043e \u0431\u043b\u0430\u0433\u043e\u0434\u0430\u0440\u043d\u043e\u0441\u0442\u0435\u0439",
...
{common:"\u0432\u044b\u043a\u043b\u044e\u0447\u0435\u043d"})},"tq.sq.reviews.filter.date.on":{handler:PK.data_tree_node_processor_makers.record({child_types:[{type:"tq.date",in_scope:"tq.date.from"},"tq.date"],name:"tq.sq.reviews.filter.date.on"},{common:"<ul>  <li><b>\u041e\u0442:</b> ${1}</li>  <li><b>\u0414\u043e:</b> ${2}</li></ul>",title:"\u0424\u0438\u043b\u044c\u0442\u0440\u043e\u0432\u0430\u0442\u044c"})},"tq.sq.reviews":{handler:PK.data_tree_node_processor_makers.record({child_types:["tq.city",
"tq.user.role","tq.sq.reviews.filter.thanks.limit","tq.sq.reviews.filter.thanks.visible","tq.sq.reviews.filter.impressions.limit","tq.sq.reviews.filter.impressions.visible","tq.sq.reviews.filter.top50","tq.sq.reviews.filter.date"],name:"tq.sq.reviews"},{common:"<ul><li><b>\u0413\u043e\u0440\u043e\u0434:</b> ${1}</li><li><b>\u0420\u043e\u043b\u044c \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f:</b> ${2}</li><li><b>\u0411\u043b\u0430\u0433\u043e\u0434\u0430\u0440\u043d\u043e\u0441\u0442\u0438:</b> ${3} <i>${4}</i></li><li><b>\u041f\u0440\u043e\u0441\u043c\u043e\u0442\u0440\u044b:</b> ${5} <i>${6}</i></li><li><b>\u0420\u0435\u0436\u0438\u043c Top-50:</b> ${7}</li><li>  <b>\u0424\u0438\u043b\u044c\u0442\u0440 \u043f\u043e \u0434\u0430\u0442\u0435 \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f \u0441\u0432\u044f\u0437\u0430\u043d\u043d\u044b\u0445 \u0441\u0443\u0449\u043d\u043e\u0441\u0442\u0435\u0439:</b>  ${8}</li></ul>",
title:"\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043a\u0430 \u043f\u043e \u043e\u0442\u0437\u044b\u0432\u0430\u043c"})},"tq.sq.users.filter.thanks.limit":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.sq.users.filter.thanks.limit"},{label:"\u0411",title:"\u0424\u0438\u043b\u044c\u0442\u0440 \u043f\u043e \u0447\u0438\u0441\u043b\u0443 \u0431\u043b\u0430\u0433\u043e\u0434\u0430\u0440\u043d\u043e\u0441\u0442\u0435\u0439",scopes:{"":[{type:"tq.sq.users.filter.thanks.limit.unlimited",
render_template:"${MENU}${1}",menu_item:"\u0432\u0441\u0435",description:""},{type:"tq.sq.users.filter.thanks.limit.lt50",render_template:"${MENU}${1}",menu_item:"&lt;10",description:""},{type:"tq.sq.users.filter.thanks.limit.50-100",render_template:"${MENU}${1}",menu_item:"10&mdash;30",description:""},{type:"tq.sq.users.filter.thanks.limit.100-300",render_template:"${MENU}${1}",menu_item:"30&mdash;100",description:""},{type:"tq.sq.users.filter.thanks.limit.gt300",render_template:"${MENU}${1}",menu_item:"&ge;100",
description:""}]}})},"tq.sq.users.filter.thanks.limit.unlimited":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.sq.users.filter.thanks.limit.unlimited"},{common:"\u0432\u0441\u0435",title:"tq.sq.users.filter.thanks.limit"})},"tq.sq.users.filter.thanks.limit.lt50":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.sq.users.filter.thanks.limit.lt50"},{common:"&lt;10",title:"tq.sq.users.filter.thanks.limit"})},"tq.sq.users.filter.thanks.limit.50-100":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.sq.users.filter.thanks.limit.50-100"},{common:"10&mdash;30",title:"tq.sq.users.filter.thanks.limit"})},"tq.sq.users.filter.thanks.limit.100-300":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.sq.users.filter.thanks.limit.100-300"},{common:"30&mdash;100",title:"tq.sq.users.filter.thanks.limit"})},"tq.sq.users.filter.thanks.limit.gt300":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.sq.users.filter.thanks.limit.gt300"},{common:"&ge;100",
title:"tq.sq.users.filter.thanks.limit"})},"tq.sq.users.filter.reviews.limit":{handler:PK.data_tree_node_processor_makers.variant({child_types:[],name:"tq.sq.users.filter.reviews.limit"},{label:"I",title:"\u0424\u0438\u043b\u044c\u0442\u0440 \u043f\u043e \u0447\u0438\u0441\u043b\u0443 \u043e\u0442\u0437\u044b\u0432\u043e\u0432",scopes:{"":[{type:"tq.sq.users.filter.reviews.limit.unlimited",render_template:"${MENU}${1}",menu_item:"\u0432\u0441\u0435",description:""},{type:"tq.sq.users.filter.reviews.limit.lt5",
render_template:"${MENU}${1}",menu_item:"&lt;3",description:""},{type:"tq.sq.users.filter.reviews.limit.5-10",render_template:"${MENU}${1}",menu_item:"3&mdash;10",description:""},{type:"tq.sq.users.filter.reviews.limit.10-50",render_template:"${MENU}${1}",menu_item:"10&mdash;30",description:""},{type:"tq.sq.users.filter.reviews.limit.gte50",render_template:"${MENU}${1}",menu_item:"&ge;30",description:""}]}})},"tq.sq.users.filter.reviews.limit.unlimited":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.sq.users.filter.reviews.limit.unlimited"},{common:"\u0432\u0441\u0435",title:"tq.sq.users.filter.reviews.limit"})},"tq.sq.users.filter.reviews.limit.lt5":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.sq.users.filter.reviews.limit.lt5"},{common:"&lt;3",title:"tq.sq.users.filter.reviews.limit"})},"tq.sq.users.filter.reviews.limit.5-10":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.sq.users.filter.reviews.limit.5-10"},{common:"3&mdash;10",
title:"tq.sq.users.filter.reviews.limit"})},"tq.sq.users.filter.reviews.limit.10-50":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.sq.users.filter.reviews.limit.10-50"},{common:"10&mdash;30",title:"tq.sq.users.filter.reviews.limit"})},"tq.sq.users.filter.reviews.limit.gte50":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],name:"tq.sq.users.filter.reviews.limit.gte50"},{common:"&ge;30",title:"tq.sq.users.filter.reviews.limit"})},"tq.sq.users.filter.date.off":{handler:PK.data_tree_node_processor_makers.literal({child_types:[],
name:"tq.sq.users.filter.date.off"},{common:"\u0432\u044b\u043a\u043b\u044e\u0447\u0435\u043d"})},"tq.sq.users.filter.date.on":{handler:PK.data_tree_node_processor_makers.record({child_types:[{type:"tq.date",in_scope:"tq.date.from"},"tq.date"],name:"tq.sq.users.filter.date.on"},{common:"<ul>  <li><b>\u041e\u0442:</b> ${1}</li>  <li><b>\u0414\u043e:</b> ${2}</li></ul>",title:"\u0424\u0438\u043b\u044c\u0442\u0440\u043e\u0432\u0430\u0442\u044c"})},"tq.sq.users":{handler:PK.data_tree_node_processor_makers.record({child_types:["tq.city",
"tq.user.role","tq.sq.users.filter.reviews.limit","tq.sq.users.filter.thanks.limit","tq.sq.users.filter.date"],name:"tq.sq.users"},{common:"<ul><li><b>\u0413\u043e\u0440\u043e\u0434:</b> ${1}</li><li><b>\u0420\u043e\u043b\u044c \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f:</b> ${2}</li><li><b>\u041e\u0442\u0437\u044b\u0432\u044b:</b> ${3}</li><li><b>\u0411\u043b\u0430\u0433\u043e\u0434\u0430\u0440\u043d\u043e\u0441\u0442\u0438:</b> ${4}</li><li>  <b>\u0424\u0438\u043b\u044c\u0442\u0440 \u043f\u043e \u0434\u0430\u0442\u0435 \u0441\u043e\u0437\u0434\u0430\u043d\u0438\u044f \u0441\u0432\u044f\u0437\u0430\u043d\u043d\u044b\u0445 \u0441\u0443\u0449\u043d\u043e\u0441\u0442\u0435\u0439:</b>  ${5}</li></ul>",
title:"\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043a\u0430 \u043f\u043e \u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u0442\u0435\u043b\u044f\u043c"})}};PK.node_schema_version={name:"ru.tulp.qb.cumulative","1":0,"2":0,"3":1};
